---
title: "Using the absmapsdata package"
author: "Will Mackey"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Using the absmapsdata package}
...
The `absmaps` exists to make it easier to produce maps from ABS data in R. The package contains compressed, tidied, and lazily-loadable `sf` objects containing geometric information about ABS data structures.
...
If you would like to do these things, please feel free to install `absmaps`. 

## I want to complain about this package

Fair enough! The best avenue is via a Github issue at (wfmackey/absmapsdata)
