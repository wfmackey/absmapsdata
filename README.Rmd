...
Note: the `absmapsdata` package is **huge**. To download and read `absmapsdata` files **without installing the whole absmapsdata package**, please see [`strayr::read_absmaps`](https://github.com/runapp-aus/strayr). E.g.: `strayr::read_absmaps("sa42021")`
